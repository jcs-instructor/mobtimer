...
Joel:
- [x] Refactor joinMobWithAutogeneratedName to not return mobName; just store in mobSocketClient instead and retrieve when needed
- [ ] Delete old branches (all but main and dev)
